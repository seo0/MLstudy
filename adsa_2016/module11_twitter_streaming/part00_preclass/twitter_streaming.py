...
if __name__ == '__main__':
    ...
    stream.filter(track=['brexit','Brexit'], async=True)        # track all the tweets in which the keywords 'brexit' and 'Brexit' appear, the async option makes sure that tracking does not block teh execution of the program
